      ...
      .left
        el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
          ...
          el-form-item(label="要求 :" class="formItem2")
            el-input(v-model="form.custName" type="textarea" :rows="2" clearable)
          el-form-item(label="落实情况 :" class="formItem2")
            el-input(v-model="form.loanAmout" type="textarea" :rows="2" clearable)
          .blueTitle 实际控制人或法定代表人风险点
          el-form-item(label="健康、 嗜好、家庭关系等方面 :" class="formItem2")
            el-input(v-model="form.loanBalance" type="textarea" :rows="2" clearable)
      ...
      .left
        el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
          ...
          el-row(:gutter="20")
            ...
            el-col(:span="24")
              el-form-item(style="width:96%")
                el-input(v-model="form.loanLength" placeholder='根据财务信息及现场检查情况，判断企业是否生产经营异常(停产、半停产、员工数量骤减、设备开工率不足等)，并详细阐述异常情况对企业偿债能力的影响。' type="textarea" :rows="2" clearable)
      .right
        el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
          .blueTitle1 营业收入
          el-row(:gutter="20")
