...
<template lang="pug">
  .Tabform2
    ...
    el-tabs(v-model="activeTab3" @tab-click="handleClick3")
      ...
      el-tab-pane(label="员工成本" name="second")
        ...
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.busInc3MSitu" :disabled="type == 2" type="textarea" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.busIncChang30Msg" :disabled="type == 2" type="textarea" :rows="3" clearable)
    .content1(v-show="activeTab3 == 'second'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.emplCost3M" :disabled="type == 2" type="textarea" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
    ...
    .content1(v-show="activeTab3 == 'three'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          ...
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.cashChang30Msg" type="textarea" :disabled="type == 2" :rows="3" clearable)
    .content1(v-show="activeTab3 == 'four'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.profit3M" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.profitChang30Msg" type="textarea" :disabled="type == 2" :rows="3" clearable)
    //- tab4
    .cardTitle1
      span(class='blue')
      span(class='title1') 财务科目
    el-tabs(v-model="activeTab4" @tab-click="handleClick4")
      el-tab-pane(label="营业成本" name="first")
    ...
    .content1(v-show="activeTab4 == 'first'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.materialCost3M" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.materialCostChang30Msg" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label=" " style="width:96%")
              el-input(v-model="form.financeInfo.financeMsg" type="textarea" :disabled="type == 2" :rows="3" clearable)
    .content1(v-show="activeTab4 == 'second'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.financeCost3M" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.financeCostChang30Msg" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label=" " style="width:96%")
              el-input(v-model="form.financeInfo.financeMsg" type="textarea" :disabled="type == 2" :rows="3" clearable)
    .content1(v-show="activeTab4 == 'three'")
      el-form(:model="form" :inline="true" label-position="top" label-width="80px" size="mini")
        el-row(:gutter="20")
          el-col(:span="12")
            el-form-item(label="近三个月的情况 :" style="width:96%")
              el-input(v-model="form.financeInfo.payTaxAmout3M" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label="如剔除季节性因素后变动超30%，原因 :" style="width:96%")
              el-input(v-model="form.financeInfo.payTaxAmoutChang30Msg" type="textarea" :disabled="type == 2" :rows="3" clearable)
          el-col(:span="12")
            el-form-item(label=" " style="width:96%")
              el-input(v-model="form.financeInfo.financeMsg" type="textarea" :disabled="type == 2" :rows="3" clearable)
</template>
